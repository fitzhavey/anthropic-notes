...
Your tool description is crucial for helping Claude understand when to use your function. Best practices:
...
Once Claude generates your schema, copy it into your code file. A good naming pattern:
