...
1. **Claude Code** — Start with this agentic coding assistant that runs in your terminal
2. **Computer Use** — Explore this set of tools that lets Claude interact with desktop applications
3. **Agents** — Understand what makes these applications successful as agents
